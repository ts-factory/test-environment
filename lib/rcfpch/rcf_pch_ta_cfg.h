...
/**
 * Name for the object type of network interface per queue interrupt
 * coalescing settings
 */
#define TA_OBJ_TYPE_IF_PQ_COALESCE "if_pq_coalesce"
...
/**
 * Name for the object type containing set of values for
 * network interface IRQs.
 */
#define TA_OBJ_TYPE_IF_IRQ "if_irq"
