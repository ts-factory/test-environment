...
static te_errno
loadavg_latest_pid_get(const ta_conf_ctx *ctx, uint64_t *val)
{
    loadavg_stats stats;
    te_errno rc;
...
static te_errno
loadavg_total_get(const ta_conf_ctx *ctx, uint64_t *val)
{
    loadavg_stats stats;
    te_errno rc;
...
static te_errno
loadavg_runnable_get(const ta_conf_ctx *ctx, uint64_t *val)
{
    loadavg_stats stats;
    te_errno rc;
...
static te_errno
loadavg_min15_get(const ta_conf_ctx *ctx, double *val)
{
    loadavg_stats stats;
    te_errno rc;
...
static te_errno
loadavg_min5_get(const ta_conf_ctx *ctx, double *val)
{
    loadavg_stats stats;
    te_errno rc;
...
static te_errno
loadavg_min1_get(const ta_conf_ctx *ctx, double *val)
{
    loadavg_stats stats;
    te_errno rc;
